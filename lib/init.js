        ...
        .then(async (answers) => {
            ...
            if(answers.framework === 'PC'){
                if(answers.URL){
                    ...
                    await clonePC('direct:https://github.com/wang12321/wlg-vue2-admin-cli#node-cli',name)
                }
            }else if(answers.framework === 'Mobile'){
                if(answers.URL){
                    await clonePC('direct:'+answers.URL,name)
                }else {
                    await cloneMobile('direct:https://github.com/wang12321/wlg-vue2-admin-cli#node-cli-mobile',name)
                }
            }
        })
}
